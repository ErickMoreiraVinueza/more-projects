...
def nombrarAnimales(prueba):
    ...
    #Con el metodo Counter verifico que las respuestas del niño sean iguales a la de la lista correcta de animales, sin importar el orden con
    #la que los escriba.            
...
def complejidadTiempo():
    """"
    Se crea la funcion para el calculo de la complejidad de tiempo del algoritmo.
