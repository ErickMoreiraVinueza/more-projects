...
def calculadorExpresion(num_expresiones):
    ...
    if(num_expresiones >= 1):
        ...
        for i in range(0,num_expresiones):
            #Almaceno el valor del numerador1.
            print('\nIngrese el valor de a de la expresión',i+1,':')
            numerador1 = float(input())
            #Almaceno el valor del numerador2.
            print('\nIngrese el valor de b de la expresión',i+1,':')
            numerador2 = float(input())
            #Calculo el valor de  y luego lo muestro en pantalla.
            resultado = (numerador1+numerador2**2)/2.5
