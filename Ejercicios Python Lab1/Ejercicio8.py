...
def calculadorRectangulo(num_rectangulos):
    """"
    Se crea la función el cálculo del área y perímetro de los rectángulos que haya elegido el usuario.
    .
    ...
    if(num_rectangulos >= 1):
        ...
        for i in range(0,num_rectangulos):
            ...
            if(base and altura >= 0):
                #Realizo el cálculo del área y perímetro para luego mostrarlos en pantalla.
                area = base*altura
...
if __name__ == '__main__':
    ...
    calculadorRectangulo(num_rectangulos)
